...
public class InfoAdapter extends RecyclerView.Adapter<InfoAdapter.InfoViewHolder>{
    ...
    public InfoAdapter(ArrayList<Question> questionArrayList, Listener listener) {
    ...
    public void onBindViewHolder(@NonNull InfoViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> listener.onItemClickListener(question));
    }
    ...
    public interface Listener{
        void onItemClickListener(Question question);
